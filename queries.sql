INSERT INTO boatbookingsdb.admin `Phone_Number`, `Email`, `City`, `S_A_Number`, `Street`, `Apt_No`, `Province`, `Zip`, `FName`, `LName`
VALUES
...
INSERT INTO boatbookingsdb.location `Phone_Number`, `City`, `S_A_Number`, `Street`, `Apt_No`, `Province`, `Zip`
VALUES
...
INSERT INTO boatbookingsdb.boat `BName`, `BType`, `SailorLicenseNo`
VALUES
...
INSERT INTO boatbookingsdb.clients `Phone_Number`, `Email`, `City`, `S_A_Number`, `Street`, `Apt_No`, `Province`, `Zip`, `FName`, `LName`
VALUES
...
INSERT INTO boatbookingsdb.member_has_membership_card `Client_ID`, `CARD_ID`, `Member_Since`
VALUES
(1, 1, '2019-11-11'),
(2, 2, '2020-03-29'),
(3, 3, '2021-10-12'),
