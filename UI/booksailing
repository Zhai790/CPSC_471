const booking={template: `
    <div>
        <button type="button" class="btn btn-dark m-2 fload-end" data-bs-toggle="modal" data-bs-target="#exampleModal" @click="addClick()">
        Add Booking
        </button>
                ...
                <tr>
                    <th>
                        <div class="d-flex flex-row">
                            <input class="form-control m-2" v-model="BookingIdFilter" v-on:keyup="FilterFunct()" placeholder="Filter by Id">

                            <button type="button" class="btn btn-light" @click="sortResult('BookingId', true)">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-square-fill" viewBox="0 0 16 16">
                                <path d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2zm6.5 4.5v5.793l2.146-2.147a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-3-3a.5.5 0 1 1 .708-.708L7.5 10.293V4.5a.5.5 0 0 1 1 0z"/>
                                </svg>
                            </button>

                            <button type="button" class="btn btn-light" @click="sortResult('BookingId', false)">
                    ...
                    <th>
                        <div class="d-flex flex-row">
                            <input class="form-control m-2" v-model="ClientNameFilter" v-on:keyup="FilterFunct()" placeholder="Filter by Name">

                            <button type="button" class="btn btn-light" @click="sortResult('ClientName', true)">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-square-fill" viewBox="0 0 16 16">
                                <path d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2zm6.5 4.5v5.793l2.146-2.147a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-3-3a.5.5 0 1 1 .708-.708L7.5 10.293V4.5a.5.5 0 0 1 1 0z"/>
                                </svg>
                            </button>

                            <button type="button" class="btn btn-light" @click="sortResult('ClientName', false)">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-up-square-fill" viewBox="0 0 16 16">
                                <path d="M2 16a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2zm6.5-4.5V5.707l2.146 2.147a.5.5 0 0 0 .708-.708l-3-3a.5.5 0 0 0-.708 0l-3 3a.5.5 0 1 0 .708.708L7.5 5.707V11.5a.5.5 0 0 0 1 0z"/>
                                </svg>
                            </button>
            ...
            <tbody>
                <tr v-for="book in booking">
                    ...
                    <td>
                        ...
                        @click="deleteClick(book.BookingId)">
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <button type="button" 
                        @click="createClick()" v-if="BookingId==0" class="btn btn-primary">
                            Create
                        </button>
                        <button type="button" 
                        @click="updateClick()" v-if="BookingId!=0" class="btn btn-primary">
                            Update
                        </button>
                    </div>
                </div>
